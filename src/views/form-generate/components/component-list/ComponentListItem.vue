...
import { Checkbox, DatePicker, FormItem, gco, Input, Radio, Select } from "@/model";
...
function onClone(item: ComponentListItemType) {
  ...
  switch (item.type) {
    ...
    case ComponentType.SELECT:
      return gco(FormItem, {}, gco(Select));
    case ComponentType.DATA_PICKER:
      return gco(FormItem, {}, gco(DatePicker));
    default:
